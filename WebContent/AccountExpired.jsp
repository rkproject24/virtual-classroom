...
<%@include file="header.jsp" %>					
		...
		<div class="left">
			<div class="left_articles">
				...
				<h2><a href="#"><u>Account Expired</u></a></h2>
				<p class="description">Your Account has expired.</p>
				<%-- /tpl:put --%>
				<%-- tpl:put name="centre_content" --%>
				<p>
					Your account has expired.
					You will not be allowed access to Virtual Classroom System.
					You can download your progress report from <a href="contactAdmin.jsp"> here </a>
				</p>
