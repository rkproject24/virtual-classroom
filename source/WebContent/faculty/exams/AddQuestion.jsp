...
<body onLoad="javascript:loadCss()">
	...
	<div class="left">
		...
		<html:hidden property="subjectId" value="<%=subjectId %>"/>
		
		<table>
			<tr><td>Question Type</td><td><html:select property="questionType">
			<html:option value="0"> Multiple Choice</html:option>
			<html:option value="1"> Fill in Blanks</html:option>
			</html:select></td><td><FONT color="red"><html:errors property="questionType"/></FONT></td></tr>
