...
<%@include file="../header.jsp" %>								
		...
		<div class="left">
			<div class="left_articles">
				...
				<p class="description">Choose your File Type.</p>
				<%-- /tpl:put --%>
		...
		<div id="right">
			...
			<div class="box">
				<p>
					<b><u>File Types</u></b><br />
					<a href="http://localhost:8080/VCS/files/view_files.jsp?fileType=0" accesskey="m">General Files</a><br />
					<a href="http://localhost:8080/VCS/files/view_files.jsp?fileType=1" accesskey="m">Lecture Files</a><br />
					<a href="http://localhost:8080/VCS/files/view_files.jsp?fileType=2" accesskey="m">Assignment Files</a><br />
				</p>
