			...
			<div class="left_articles">
				...
				<%
					...
					for(int i =0;i<list.size();i++)
					{
						...
						String postedDate = bean.getPostingDate();
						String description = bean.getDescription();
						String postedby = bean.getPostedBy();
						String url = "notice_description.jsp?desc=" + description;
					%>
						
					<tr><th scope="row"><input type="checkbox" name="notice"
					value="<%=noticeid%>"><a href="#" onclick = "javascript:jah1('<%=url %>','id2')"><%=title %></a></th><td><%= postedDate %></td><td><%= postedby %></td></tr>		
					<%
					}
