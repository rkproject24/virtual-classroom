...
<%
				java.util.ArrayList fileList = (java.util.ArrayList)request.getSession().getAttribute("lectureList");	
				if(!(fileList.size() == 0))
				{
 %>
					...
					<%
						...
						for(int i = 0;i<fileList.size();i++)
						{
							...
							String url = "file_description.jsp?desc=" + description + "&fileName=" + fileName + "&filePath=" + filePath + "&fileType=1" ;
