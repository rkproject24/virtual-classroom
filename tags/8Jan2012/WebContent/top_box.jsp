...
<%@page import="com.ignou.vcs.files.database.FilesDatabaseActivities"%><html:html>
<head>
<title>top_box</title>
...
<%
	...
	if(allFiles.size()>0){
		for(int i = 0; i < 3 ; i++) {
			FileBean fileBean = (FileBean)allFiles.get(0);
			...
			String imageLink = "http://localhost:8080/VCS/displayImage.jsp?fp=" + image + "&tp=" + type;
