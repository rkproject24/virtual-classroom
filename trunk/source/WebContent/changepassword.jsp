...
<%@include file="header.jsp" %>								
		...
		<div class="left">
			<div class="left_articles">
				...
				<h2><a href="#"><u>Change Password</u></a></h2>
				...
				<TABLE>
					<TBODY>
						<TR>
							<TD align="left" width = "200"><b>Old password:</b></TD>
							
							<TD><html:password property="oldPassword"></html:password></TD>
						</TR>
						<TR>
							<TD align="left" width = "200"><b>New password:</b></TD>
							
							<TD><html:password property="newPassword"></html:password></TD>
						</TR>
						<TR>
							<TD align="left" width = "200"><b>Retype new password:</b></TD>
							
							<TD><html:password property="newPassword2"></html:password></TD>
						</TR>
						<TR>
							<TD align="left" width = "200"><html:submit property="Submit"
