...
<%@include file="../header.jsp" %>								
		...
		<div class="left">
			<div class="left_articles">
				...
				<h2><a href="#"><u>Student Report</u></a></h2>
				<p class="description"></p>
				<%
					VCSDatabaseActivities dbObj = new VCSDatabaseActivities();
					java.util.ArrayList course_list = (java.util.ArrayList)dbObj.getAllCourses(); 
				%>	
					<table> 
					 	<tr width = "240">
				...
				<%
					for(int i = 0; i < course_list.size();i++)
					{
						...
						courseBean bean = (courseBean)course_list.get(i);
						String courseName = bean.getCoursename();
						int courseid = bean.getCourseid();
					%>
						<tr width = "240">
							<td width = "30"><%=i+1 %></td>
							<td width = "200"><a href = "studentReportDesc.jsp?courseid=<%=courseid %>" target="new"><%=courseName %></a></td>
						</tr>		
					<%
					}
					%>
